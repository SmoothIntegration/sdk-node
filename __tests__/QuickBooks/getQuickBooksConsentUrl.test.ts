...
describe('QuickBooks: getConsentUrl', () => {
    test('Returns Consent Url on 200 Response', async () => {
        mockFetch({
            method: 'GET',
            url: '/quickbooks/connect?company_id=a5c8d02c-f8dd-45ee-9495-53c1781501b7',
            response: {
    ...
    test('Returns Consent Url for SandBox companies on 200 Response', async () => {
        mockFetch({
            method: 'GET',
            url: '/quickbooks/connect?company_id=a5c8d02c-f8dd-45ee-9495-53c1781501b7&sandbox=true',
            response: {
                message: 'Created Consent Url',
                result: {
                    consentUrl: 'the-consent-url',
    ...
    test('Raises SIError: Bad Request on 400 Response', async () => {
        mockFetch({
            method: 'GET',
            url: '/quickbooks/connect?company_id=a5c8d02c-f8dd-45ee-9495-53c1781501b7',
            response: { message: 'QuickBooks is not configured for this organisation' },
            status: 400,
        });
    ...
    test('Raises SIError: Unauthorized on 401 Response', async () => {
        mockFetch({
            method: 'GET',
            url: '/quickbooks/connect?company_id=invalid-company-id',
